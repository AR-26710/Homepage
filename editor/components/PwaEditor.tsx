      ...
      {configData?.pwa && (
        <div className="space-y-4">
          <div className="flex items-center gap-3 px-2">
            <div className="w-6 h-6 bg-linear-to-br from-blue-400 to-blue-600 rounded-lg flex items-center justify-center">
        ...
        {showAdvanced && (
          <div className="mt-4 space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h5 className="font-medium text-gray-900 mb-2">Service Worker 更新配置</h5>
              <div className="space-y-2 text-sm">
                <div>
                  <span className="font-medium text-gray-700">clientsClaim: true</span>
                  <p className="text-gray-600">新 Service Worker 立即控制所有客户端页面</p>
                </div>
                <div>
                  <span className="font-medium text-gray-700">skipWaiting: true</span>
                  <p className="text-gray-600">新 Service Worker 立即激活，无需等待旧客户端关闭</p>
                </div>
                <div>
                  <span className="font-medium text-gray-700">additionalManifestEntries</span>
                  <p className="text-gray-600">手动添加需要预缓存的资源，使用 revision: auto 自动更新</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-green-800">
                  <p className="font-medium mb-1">自动更新机制</p>
                  <ul className="space-y-1 list-disc list-inside">
                    <li>部署新版本后，Service Worker 会自动检测更新</li>
                    <li>新版本会立即激活并控制所有页面</li>
                    <li>用户无需手动卸载或清除缓存</li>
                    <li>资源内容变化时缓存会自动更新</li>
                  </ul>
                </div>
              </div>
            </div>
